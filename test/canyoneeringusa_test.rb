...
class CanyoneeringUSATest < Minitest::Test
    ...
    #     input_hash = Hash.new('cedar-mesa' => { 'cheesebox-canyon' => { 'RATINGS' => 'Fry: 3B II★★★\nFrylette: 2B I★★'}})
    #     output_hash = Hash.new('cedar-mesa' => { 'cheesebox-canyon' => { 'RATINGS' => 'Fry: 3B II\nFrylette: 2B I', 'RANKINGS' => ['★★★', '★★']}})
